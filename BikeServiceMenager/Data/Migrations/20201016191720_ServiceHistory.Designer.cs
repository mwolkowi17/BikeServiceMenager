...
namespace BikeServiceMenager.Data.Migrations
{
    ...
    [Migration("20201016191720_ServiceHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.Bike", b =>
                {
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.Client", b =>
                {
                    ...
                    b.Property<DateTime>("YearOfBecameClient")
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.ServiceHistory", b =>
                {
                    ...
                    b.Property<int?>("ServiceActionHistoryServiceActionId")
                        .HasColumnType("int");

                    b.HasKey("ServiceHistoryId");

                    b.HasIndex("ServiceActionHistoryServiceActionId");
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.ServiceOrder", b =>
                {
                    ...
                    b.Property<int?>("BikeToServiceOwnerClientId")
                        .HasColumnType("int");

                    b.Property<DateTime>("DateOfOrderOpen")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("BikeToServiceOwnerClientId");
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.Bike", b =>
                {
                    b.HasOne("BikeServiceMenager.Models.Client", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.ServiceHistory", b =>
                {
                    b.HasOne("BikeServiceMenager.Models.ServiceAction", "ServiceActionHistory")
                        .WithMany()
                        .HasForeignKey("ServiceActionHistoryServiceActionId");
                });
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.ServiceOrder", b =>
                {
                    b.HasOne("BikeServiceMenager.Models.Bike", "BikeToService")
                        .WithMany()
                        .HasForeignKey("BikeToServiceBikeId");

                    b.HasOne("BikeServiceMenager.Models.Client", "BikeToServiceOwner")
                        .WithMany()
                        .HasForeignKey("BikeToServiceOwnerClientId");
                });
