...
namespace BikeServiceMenager.Data.Migrations
{
    ...
    [Migration("20201119184824_datetobeready")]
    partial class datetobeready
    {
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.ServiceHistory", b =>
                {
                    ...
                    b.Property<int?>("ServiceOrderHistoryServiceOrderId")
                        .HasColumnType("int");

                    b.HasKey("ServiceHistoryId");

                    b.HasIndex("ServiceOrderHistoryServiceOrderId");
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.ServiceOrder", b =>
                {
                    ...
                    b.Property<DateTime>("DateToBeReady")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BikeServiceMenager.Models.ServiceHistory", b =>
                {
                    b.HasOne("BikeServiceMenager.Models.ServiceOrder", "ServiceOrderHistory")
                        .WithMany()
                        .HasForeignKey("ServiceOrderHistoryServiceOrderId");
                });
